...
<a class="navbar-brand" href="index.html"> Khushi Shah </a>
...
<div class="collapse navbar-collapse " id="navbarSupportedContent">
  <ul class="navbar-nav ml-auto" id = "navbar-content">
   ...
   <li class="nav-item nav-item-hover"><a class="nav-link" href="https://drive.google.com/file/d/1Lx-8VlXLhd2TlmOQ9Jo1Xedtx4FfMXS8/view?usp=sharing" target="_blank">Resume</a></li>
...
<footer class="footer sticky-bottom"  style="background-color:#2b2a2a;">
  <div class="p-4">
    <div class="container-fluid quote-container">
      ...
      <p class="tag" >We can not solve our problems with the same level of thinking that created them.</p>
    </div>
    ...
    <div class="col-lg-6 col-md-12 mb-4 mb-md-0 form-comtainer">
          <div class="form-style-6">
             <div class="form-header">
                ...
                <form name="form1" action="https://formcarry.com/s/jtI8mFuuA" method="POST" accept-charset="UTF-8" >
    ...
    <a class="social-button linkedin" href="https://www.linkedin.com/in/khushi-shah-961a181a6/" target="_blank" >
